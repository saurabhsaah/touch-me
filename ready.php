...
<meta property="og:type" content="स्वतंत्रता दिवस की हार्दिक शुभकामनाए॥" />
<meta property="og:title" content="स्वतंत्रता दिवस की हार्दिक शुभकामनाए॥" />
<meta property="og:description" content="स्वतंत्रता दिवस की हार्दिक शुभकामनाए॥" />
<meta property="og:site_name" content="स्वतंत्रता दिवस की हार्दिक शुभकामनाए॥" />
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-135142918-8"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-135142918-8');
</script>
<style>
body{
        background: #f8f8f8;
...
#usernameb { color: black;  /* Fallback: assume this color ON TOP of image */
   background: url(img/sname.gif?v=5?v=3);
...
<img src="img/i1.png?v=51" height="30px" width="20px" /><br><br>
<img src="img/i2.png?v=51" height="30px" width="20px" /><br><br>
<img src="img/i3.png?v=51" height="30px" width="20px" /><br><br>
<img src="img/i4.png?v=51" height="30px" width="20px" /><br><br>
<img src="img/i1.png?v=51" height="30px" width="20px" /><br><br>
<img src="img/i2.png?v=51" height="30px" width="20px" /><br><br>
<img src="img/i3.png?v=51" height="30px" width="20px" /><br><br>
<img src="img/i4.png?v=51" height="30px" width="20px" /><br><br>
...
<h1 style="background: url(img/namegif.gif?v=12454);-webkit-text-fill-color: transparent;-webkit-background-clip: text;" id="name"></h1>
</div>
<h3 class="fromMessage" id="fromMessage"></h3>
<img src="img/kiTarafSe.png?v=12?v=3" width="60%" style="animation: pulse 0.5s infinite">
<p id="demo"></p>
<div class="pyro">
...
<br>
<img src="img/main.png?v=5653" width="100%" height="auto" style="animation: pulse 1s infinite"><br>
<img src="img/main2.png?v=312" width="80%">
<div style="background-color: #FF6800; border-radius: 17px; border: 0px solid rgb(0, 0, 0); box-shadow: rgba(0, 0, 0, 0.2) 5px 5px 5px; color: white; font-family: arial, sans-serif; font-size: 18px; font-stretch: normal; font-style: normal; font-variant: normal; line-height: normal; margin: 0px auto; padding: 4px 5px 3px; width: 82%;">
<b>
कुछ नशा तिरंगे की आन का है,</b>
</div>
<div style="background-color: #FF6800; border-radius: 17px; border: 0px solid rgb(0, 0, 0); box-shadow: rgba(0, 0, 0, 0.2) 5px 5px 5px; color: white; font-family: arial, sans-serif; font-size: 18px; font-stretch: normal; font-style: normal; font-variant: normal; line-height: normal; margin: 0px auto; padding: 4px 5px 3px; width: 82%;">
<b>
कुछ नशा मातृभूमि की शान का है,</b>
</div>
<div style="background-color: white; border-radius: 17px; border: 0px solid rgb(0, 0, 0); box-shadow: rgba(0, 0, 0, 0.2) 5px 5px 5px; color: black; font-family: arial, sans-serif; font-size: 18px; font-stretch: normal; font-style: normal; font-variant: normal; line-height: normal; margin: 0px auto; padding: 4px 5px 3px; width: 82%;">
<b>
हम लहराएंगे हर जगह ये तिरंगा,</b>
</div>
<div style="background-color: green; border-radius: 17px; border: 0px solid rgb(0, 0, 0); box-shadow: rgba(0, 0, 0, 0.2) 5px 5px 5px; color: white; font-family: arial, sans-serif; font-size: 18px; font-stretch: normal; font-style: normal; font-variant: normal; line-height: normal; margin: 0px auto; padding: 4px 5px 3px; width: 82%;">
<b>
नशा ये हिंदुस्तान की शान का है<b>
</div>
<div style="background-color: green; border-radius: 17px; border: 0px solid rgb(0, 0, 0); box-shadow: rgba(0, 0, 0, 0.2) 5px 5px 5px; color: white; font-family: arial, sans-serif; font-size: 18px; font-stretch: normal; font-style: normal; font-variant: normal; line-height: normal; margin: 0px auto; padding: 4px 5px 3px; width: 82%;">
<b>
स्वतंत्रता दिवस की हार्दिक शुभकामनाए </b>
<br>
</div>
<span style="font-size:22px;text-shadow: 1px 1px 3px #FFEB3B, 1px 1px 3px #FFEB3B, -1px -1px 3px #FFEB3B, -1px -1px 3px #FFEB3B;color:#E91E63;"><marquee><b><i>“ Wish you Happy 76th Independence Day!!”</b></i></marquee></span><br>
<br>
<br>
<div class="glow"></b></h1></div>
<br><br>
<a class="footerbtn" href="whatsapp://send?text=** ने आपको एक *ख़ास* चीज भेजी है  %0A ब्लू लाइन को टच करके जल्दी देखो 😲  %0A 👇 👇%0Atouch-karo.in/?n="><img width="25px" height="25px" src="img/whatsapp.png?v=198556?val=3" /><b style="font-size: 19px;">यहाँ से सबको भेजो </b> <img width="25px" height="25px" src="img/whatsapp.png?v=198556?val=3" />
</a>
